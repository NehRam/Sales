[assembly:Xamarin.Forms.ExportRenderer(typeof(Sales.Views.LoginFacebookPage), typeof(Sales.Droid.Implementations.LoginFacebookPageRenderer))]
        ...
        public LoginFacebookPageRenderer()
        {
            ...
            auth.Completed += async (sender, eventArgs) =>
            {
                if (eventArgs.IsAuthenticated)
                {
                    ...
                    await App.NavigationToProfile(token);
                }
                else
                {
                    App.HideLoginView();
